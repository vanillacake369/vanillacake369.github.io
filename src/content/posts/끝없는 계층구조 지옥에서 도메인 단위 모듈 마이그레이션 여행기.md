---
title: "끝없는 계층구조 지옥에서 도메인 단위 모듈 마이그레이션 여행기"
...
도메인 모델 풍부화 (행위와 상태를 함께 표현)
    2.

응용 레이어는 오직 흐름(Use Case)만 담당
    3.

도메인 내부에서 필요한 정책·검증은 도메인 객체에 위임
    4.
