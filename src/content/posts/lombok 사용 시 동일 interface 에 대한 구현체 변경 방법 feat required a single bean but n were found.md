---
title: "lombok 사용 시 동일 interface 에 대한 구현체 변경 방법 (feat. required a single bean, but n were found,,)"
...
2. Constructor Injection 을 하지 않기에 위험함 
...
[Java - Lombok + Spring에서 @Qualifer 적용 이슈](https://velog.io/@mertyn88/Lombok-Spring에서-Qualifer-적용-이슈)

[롬복(lombok)에서 생성자 필드에 선언된 애노테이션을 복사적용하는 것](https://gist.github.com/ihoneymon/8b62cabb2e985c4ebd29271b3e25181f)

[@NoArgsConstructor, @RequiredArgsConstructor, @AllArgsConstructor](https://projectlombok.org/features/constructor)

[@Autowired VS @Resource 그리고 @Qualifier](https://luceatluxvestra.tistory.com/18)
