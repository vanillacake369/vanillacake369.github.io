...
[GitHub - wkrzywiec/library-hexagonal: An example application written in Hexagonal (Ports and Adapter) architecture](https://github.com/wkrzywiec/library-hexagonal/tree/master)
