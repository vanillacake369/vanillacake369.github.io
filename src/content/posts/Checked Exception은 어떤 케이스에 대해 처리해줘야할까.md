...
> The [Oracle Java Documentation](https://docs.oracle.com/javase/tutorial/essential/exceptions/runtime.html) provides guidance on when to use checked exceptions and unchecked exceptions:
> 박성원 튜터님 왈
