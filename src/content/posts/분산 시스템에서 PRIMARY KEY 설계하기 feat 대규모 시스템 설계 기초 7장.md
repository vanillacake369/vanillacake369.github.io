---
title: "분산 시스템에서 PRIMARY KEY 설계하기 (feat. 대규모 시스템 설계 기초 7장)"
description: "왜 분산 시스템에 대해 PRIMARY KEY 값 설계를 따로 고려해야할까??"
date: 2024-03-10
tags: [primary key, 대규모 시스템 설계 기초, 분산 시스템]
...
그러기에는 쉽지 않다. 왜냐하면 아래 특성을 고려해야하기 때문이다.
