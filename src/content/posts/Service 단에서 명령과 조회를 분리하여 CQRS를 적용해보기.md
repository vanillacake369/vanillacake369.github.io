---
title: "Service 단에서 명령과 조회를 분리하여 CQRS를 적용해보기"
...
이러한 점은 여러 부작용을 야기한다.
    - Vendor Lock-In : 모든 리소스를 AWS에 의존하여 AWS Vendor 에 Lock-In 되는 현상을 말한다.

상황이나 비용에 맞춰 다른 Cloud Service 사용하거나 커스텀할 수 있어야 하는데 그러지 못 하게 된다.
    - 굉장한 비용부담 : RDS 자체적으로도 굉장히 비싼 편에 속한다.
