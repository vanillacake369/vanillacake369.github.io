...
NixOS 는 정확히 이 빈 자리를 메우는 도구다.

게다가 그 방식이 놀라울 정도로 명료하고 논리적이다.
...
이를 패키지 빌드에 그대로 적용하면 다음 그림이 나온다.
...
앞 세 단계는 §Nix 동작 원리에서 본 파이프라인 그대로다.
...
캐시에 있는 것은 다운로드되고, 없는 것만 로컬에서 빌드된다.
...
NixOS 는 `boot.initrd.availableKernelModules` 에 적힌 모듈들을 포함하는 임시 파일 시스템(initrd)을 빌드해 둔다.
...
[^8]: ^8]: How Nix Works. [https://nixos.org/guides/how-nix-works/ <https://nixos.org/guides/how-nix-works/>
[^9]: ^9]: NixOS Manual — Activation Script. [https://nixos.org/manual/nixos/unstable/#sec-activation-script <https://nixos.org/manual/nixos/unstable/#sec-activation-script>
[^10]: ^10]: nixpkgs / activation-script.nix. [https://github.com/NixOS/nixpkgs/blob/master/nixos/modules/system/activation/activation-script.nix <https://github.com/NixOS/nixpkgs/blob/master/nixos/modules/system/activation/activation-script.nix>
[^11]: ^11]: nixpkgs / top-level.nix. [https://github.com/NixOS/nixpkgs/blob/master/nixos/modules/system/activation/top-level.nix <https://github.com/NixOS/nixpkgs/blob/master/nixos/modules/system/activation/top-level.nix>
[^12]: ^12]: nix.dev — Module System Tutorial. [https://nix.dev/tutorials/module-system/ <https://nix.dev/tutorials/module-system/>
[^14]: https://shopify.engineering/what-is-nix <https://shopify.engineering/what-is-nix>
[^15]: https://nix.dev/tutorials/nix-language.html#derivations <https://nix.dev/tutorials/nix-language.html#derivations>
[^16]: https://zero-to-nix.com/concepts/derivations/ <https://zero-to-nix.com/concepts/derivations/>
