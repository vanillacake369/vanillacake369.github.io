...
명령 모드와 입력 모드를 분리하는 *모달 편집(modal editing)* 방식을 도입했다.
...
다른 파일을 수정할 필요가 없다.
특히 `languages.lua` 는 *단일 진실 원천(Single Source of Truth)* 역할을 한다.
...
*지연 로딩(lazy loading)* 이란 플러그인을 Neovim 시작 시 전부 로드하지 않고, 특정 조건이 충족될 때 비로소 로드하는 전략이다.
...
*ghost text* 기능을 활성화하면 커서 위치에 반투명한 제안 텍스트가 인라인으로 표시된다.
...
1. Microsoft. Language Server Protocol Specification. [https://microsoft.github.io/language-server-protocol/](https://microsoft.github.io/language-server-protocol/)[↩︎](https://www.notion.so/vanillacake369/Neovim-20a19c3902908068aca9c95a9aaee77e#fnref-1)
2. Neovim. Lua Guide - Configuration. [https://neovim.io/doc/user/lua-guide.html#lua-guide-config](https://neovim.io/doc/user/lua-guide.html#lua-guide-config)[↩︎](https://www.notion.so/vanillacake369/Neovim-20a19c3902908068aca9c95a9aaee77e#fnref-2)
3. folke. lazy.nvim Spec Import. [https://lazy.folke.io/spec#spec-import](https://lazy.folke.io/spec#spec-import)[↩︎](https://www.notion.so/vanillacake369/Neovim-20a19c3902908068aca9c95a9aaee77e#fnref-3)
4. folke. lazy.nvim - A modern plugin manager for Neovim. [https://lazy.folke.io/](https://lazy.folke.io/)[↩︎](https://www.notion.so/vanillacake369/Neovim-20a19c3902908068aca9c95a9aaee77e#fnref-4)
5. mfussenegger. nvim-jdtls - Extensions for the built-in LSP support for eclipse.jdt.ls. [https://github.com/mfussenegger/nvim-jdtls](https://github.com/mfussenegger/nvim-jdtls)[↩︎](https://www.notion.so/vanillacake369/Neovim-20a19c3902908068aca9c95a9aaee77e#fnref-5)
6. stevearc. conform.nvim - Lightweight yet powerful formatter plugin. [https://github.com/stevearc/conform.nvim](https://github.com/stevearc/conform.nvim)[↩︎](https://www.notion.so/vanillacake369/Neovim-20a19c3902908068aca9c95a9aaee77e#fnref-6)
7. mfussenegger. nvim-lint - An asynchronous linter plugin. [https://github.com/mfussenegger/nvim-lint](https://github.com/mfussenegger/nvim-lint)[↩︎](https://www.notion.so/vanillacake369/Neovim-20a19c3902908068aca9c95a9aaee77e#fnref-7)
8. folke. snacks.nvim - A collection of small QoL plugins. [https://github.com/folke/snacks.nvim](https://github.com/folke/snacks.nvim)[↩︎](https://www.notion.so/vanillacake369/Neovim-20a19c3902908068aca9c95a9aaee77e#fnref-8)
