...
3. 네트워크 설정 : 네임스페이스 내부에 veth 인터페이스 활성화, IP 주소, 기본 라우트 설정
4. 브리지 생성
5. veth 와 브리지 연결, 활성화
6. 네트워크 구조 동작 여부 확인 :: 통신 테스트
...
[https://insight.infograb.net/blog/2025/04/09/linux-container/](https://insight.infograb.net/blog/2025/04/09/linux-container/)
