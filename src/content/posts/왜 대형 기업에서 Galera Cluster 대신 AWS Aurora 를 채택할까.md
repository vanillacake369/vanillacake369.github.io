...
>[MariaDB Galera Cluster: SELECT ... FOR UPDATE why no locking?](tps://stackoverflow.com/questions/50984715/mariadb-galera-cluster-select-for-update-why-no-locking)
...
- [MySQL/MariaDB 환경에서 다중 마스터 복제를 지원하는 Galera Cluster 알아보기](https://sungwookkang.com/entry/MySQLMariaDB-환경에서-다중-마스터-복제를-지원하는-Galera-Cluster-알아보기)

- [Running Galera Cluster on Amazon EC2 and comparing it to RDS and Aurora](https://galeracluster.com/videos/running-galera-cluster-on-amazon-ec2-and-comparing-it-to-rds-and-aurora/)

- [aws에서 MariaDB galega Cluster 사용하기 ver.2](https://linuxer.name/tag/aws-rds/)

- [What happened to Aurora MySQL multi-master option? | Reddit](https://www.reddit.com/r/aws/comments/11vsvow/what_happened_to_aurora_mysql_multimaster_option/)

- [LIMITATIONS OF GALERA CLUSTER](https://fromdual.com/limitations-of-galera-cluster#:~:text=Galera%20Cluster%20is%20primarily%20a,or%20even%20real%20time%20behaviour.)

- [What is multi-master replication and why it matters at scale](https://arpitbhayani.me/blogs/multi-master-replication/)

- [Galera Load Balancer](https://galeracluster.com/2022/11/seamless-failover-with-galera-load-balancer/)

- [Deadlock Found during a Transaction¶](https://galeracluster.com/library/kb/deadlock-found.html)

- [Frequently Asked Questions¶](https://galeracluster.com/library/faq.html)
