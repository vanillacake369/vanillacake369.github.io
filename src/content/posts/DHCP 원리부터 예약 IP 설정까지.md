...
리눅스 커널이 NIC(Network Interface Card) 감지
2. udev가 장치 이벤트 수신
3.
...
NetworkManager / systemd-networkd / ifupdown 중 하나 실행
...
위 [DHCP 적용 실습](https://www.notion.so/2ce19c3902908024b792f01b2a42e9eb#2d119c39029080bd8deddfdd0666248c) 을 따라서 DHCP 활성화 해준다.
2.

DHCP 예약 IP 지정
3. [3.

DHCP 적용 확인](https://www.notion.so/2ce19c3902908024b792f01b2a42e9eb#2d819c39029080fd8225dff5f47f73b7) 이후 DHCP 할당 정보 리스트 확인
4.
