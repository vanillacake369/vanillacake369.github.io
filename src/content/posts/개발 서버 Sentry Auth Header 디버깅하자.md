---
title: "개발 서버 Sentry Auth Header  디버깅하자"
...
디깅 도중 Sentry Doc AI 를 통해 -- 생각보다 잘 만들어져있다. 사내 도메인 기획에도 적용할 생각이다 -- [Attach HTTP headers to Sentry request #594](https://github.com/getsentry/sentry-java/issues/594) 를 찾게되었고, 해당 이슈에서 Header 값을 미리 지정하여 넘길 수 있다는 것을 알게 되었다.
...
- 하지만 팀 내에서 모니터링 서버 도입을 꺼려했다.
   ...
   - 납득을 못 하는 건 아니다. 시장성과 제품 출시시점은 반비례하니,,
