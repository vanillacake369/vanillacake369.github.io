...
1. jpa의 platform을 지정해주었다.

자동으로 설정하게 두면, 혹여나 H2 DB에 접근하려나 싶었기 때문이다.
2.

그 다음 hibernate의 ddl-auto를 create-drop이 아닌 create로 두었다.
3. generate-ddl을 true로 설정하였다.

스키마를 정의하는 언어인 ddl문을 생성할 수 있게 옵션을 켜놓는 것이다.
