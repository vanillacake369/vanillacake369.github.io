---
description: "객체지향 설계 원칙을 적용해 온라인 영화 예매 시스템을 구축하고, 할인 정책·조건을 역할 단위로 분리한 실습 기록이다."
date: 2024-05-12
tags: [system-design]
lang: ko
draft: false
...
- 할인정책은 금액할인정책과 비율할인정책이 있다. 영화별로 하나의 할인정책만 할당할 수 있으며, 할인정책을 지정하지 않는 것도 가능하다.
...
[^1]: <https://medium.com/29cm/값-객체-value-object-를-활용하여-변경-용이성-개선하기-7457787b84c0>

[^2]: <https://inpa.tistory.com/entry/GOF-💠-Enum-Factory-Method-변형-패턴>

[^3]: <https://velog.io/@qwe916/팩토리-메서드-패턴-Factory-Method-Pattern>

[^4]: <https://www.youtube.com/watch?v=26S4VFUWlJM&t=2176s&ab_channel=WorkerKSUG>
